...
PUBLISHERS -> BOOKS (один-ко-многим)
    
    - Одно издательство может выпускать много книг
    
    - Каждая книга выпускается одним издательством

READERS -> BORROWINGS (один-ко-многим)
    
    - Один читатель может совершать много выдач
    
    - Каждая выдача принадлежит одному читателю

BOOKS -> BORROWINGS (один-ко-многим)
    
    - Одна книга может быть выдана много раз в разные моменты времени
